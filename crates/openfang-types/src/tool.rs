...
pub struct ToolResult {
    ...
    pub is_error: bool,
    /// Whether this tool already delivered the response to the user
    /// (e.g. voice/video message sent via MCP side-channel).
    /// When true, the agent loop should exit silently without another LLM round.
    #[serde(default)]
