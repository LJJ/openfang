...
const DEFAULT_IMAGE_DESCRIPTION_PROMPT: &str = "请用中文、基于可见证据客观具体地描述图片。重点说明画面主体、服装类型、颜色、版型轮廓、显著细节、背景和可读文字。不要声称图片之外已经发生了什么动作；如果不确定，就明确说不确定。";
